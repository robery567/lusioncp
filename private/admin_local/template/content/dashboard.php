			...
			<div class="row">
				...
				<!-- /.panel-heading -->
					...
					<div class="panel panel-default">
					  ...
					  <div class="panel-heading">
							<strong>SERVERS STATISTICS</strong>
						</div>
						<!-- /.panel-heading -->
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td><strong><font color="red"><?php if (!$offline) echo "100%"; else echo "0"; ?></font></strong></td>
											 <td><strong><font color="orange"><?php if (!$offline) echo "58%"; else echo "0"; ?></font></strong></td>
											<td><font color="grey"><?php if (!$offline) echo $remote->ramMemory(); else echo "0"; ?></font></td>
							...
							<div class="table-responsive">
							 ...
							 <?php 
								if (!$offline) {
									...
									echo '<button type="button" class="btn btn-danger disabled">Restart</button><img src="//lusioncp.me/spin.gif" alt="Loading..." width="20" height="20">
